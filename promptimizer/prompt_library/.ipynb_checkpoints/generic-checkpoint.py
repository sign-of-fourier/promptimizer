...
writer_system = "You are a prompt engineer. Your job is to write prompts that classify text."

writer_user = """Write a prompt that instructs a language model to {}. Tell the model that it will be given some text and instruct it to determine the disease based on:
